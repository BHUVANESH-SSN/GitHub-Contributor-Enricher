"""
Purpose: Discover LinkedIn profile URLs for contributors by querying an Apify search actor.
Input: Contributor records containing names, GitHub logins, and optional company hints.
Output: Returns contributor records enriched with `linkedin_url` values.
"""
import json
import time
